  ...
  return (
    <main className="flex flex-col bg-[#94221a] w-full h-full text-white"
      ...
      <div className="flex border-b-[3px] border-black">
        ...
        <div
          className="flex flex-col justify-between w-full max-w-[750px] border-l-[3px] border-black">
          ...
          <div className="flex h-[30%]">
            <div className="flex justify-center items-center w-[50%] border-r-[3px] border-black">
              <div className="flex flex-col text-center gap-y-2">
                <p className="text-5xl font-semibold font-normal">100K</p>
      ...
      <div className="flex justify-start h-[300px] w-full bg-[#131313]">
        <div className="flex flex-1 p-8 pr-32 pl-24 text-white/50">
          <div>
            <div className="flex flex-col justify-center gap-y-4">
              ...
              <p className="text-4xl tracking-widest leading-relaxed font-semibold text-white/80">NEW LORIAN EVENING
                DRESS DESIGN</p>
              <p className="leading-relaxed">We are discovering a new fashion style, buy from Lorian Store and become one of us</p>
            </div>
          </div>
          <div className="flex gap-x-6">
            <Image src={arrival} alt={"arrival"} className="w-[250px] h-[250px]" />
            <div className="bg-[#090909] p-4 h-fit w-fit">
              <TfiArrowRight size={30} color={"white"} />
            </div>
          </div>
        </div>
        <div className="flex p-8 flex-col text-white/50 w-full max-w-[750px] border-l-[3px] border-black">
          ...
          <p className="text-4xl -mt-7 tracking-widest leading-relaxed font-semibold text-white/80 mb-4 w-[70%]">OUR NEW DRESS COLLECTION</p>
