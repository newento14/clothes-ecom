...
export default function Home() {
  return (
    <main className="flex flex-col bg-[#94221a] w-full h-full text-white"
      ...
      <div className="flex max-xl:flex-col border-b-[3px] border-black">
        <div className="flex justify-center items-center w-full">
          <Image src={hero} alt={"hero"} className="max-xl:hidden w-fit max-h-[calc(100vh-80px)] object-cover" />
        </div>
        <div className="flex flex-col justify-between w-full max-xl:max-w-max max-w-[750px] border-l-[3px] border-black">
          ...
          <div className="flex h-[30%]">
            <div className="flex justify-center items-center w-[50%] border-r-[3px] border-black">
              <div className="flex flex-col text-center gap-y-2 max-xl:p-5">
                <p className="text-5xl font-normal">100K</p>
                <p className="text-xl text-white/60">Customers</p>
              </div>
            </div>
            <div className="w-full">
              <div className="flex justify-center h-full items-start text-start flex-col gap-y-2 px-16 max-xl:p-5">
      ...
      <div className="flex max-xl:flex-col max-xl:border-b-2 max-xl:border-black justify-start w-full h-fit bg-[#131313]">
        <div className="flex justify-between max-2xl:p-2 p-8 pl-24 w-full xl:pr-32 extra:pr-8 text-white/50 max-xl:border-b-2 max-xl:border-black max-xl:mb-6 max-xl:pb-6">
          <div>
          ...
          <div className="flex gap-x-6 w-fit justify-start">
            <Image src={arrival} alt={"arrival"} className="object-cover h-[200px] 2xl:h-fit max-xl:hidden" />
            <div className="bg-[#090909] p-4 h-fit w-fit hover:bg-[#94221a]">
              <TfiArrowRight size={30} color={"white"} />
            </div>
          </div>
        </div>
        <div className="flex p-8 flex-col max-2xl:p-2 text-white/50 w-full max-xl:max-w-full max-w-[750px] border-l-[3px] border-black">
          <div className="flex justify-between items-start">
