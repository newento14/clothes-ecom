    ...
    <main className="flex flex-col bg-[#94221a] w-full h-full text-white"
        ...
        <motion.div
          ...
          <div className="flex h-[30%]">
            <div className="flex justify-center items-center w-[50%] border-r-[3px] border-black">
              <motion.div
                initial={{y: 50, opacity: 0, zIndex: 0}}
                animate={{y: 0, opacity: 1}}
                transition={{type: 'spring', duration: 0.7, delay: 1.1}}
      ...
      <div className="flex justify-start w-full h-fit bg-[#131313]">
        <motion.div
          initial={{x: -100, opacity: 0, zIndex: 0}}
          animate={{x: 0, opacity: 1}}
          transition={{type: 'spring', duration: 0.7, delay: 1.2}}
          className="flex justify-between max-2xl:w-fit max-2xl:p-2 max-2xl:pr-[141px] p-8 pl-24 w-full pr-32 extra:pr-8 text-white/50">
          <div>
          ...
          <div className="flex gap-x-6 w-fit">
            ...
            <motion.div
              ...
              className="bg-[#090909] p-4 h-fit w-fit hover:bg-[#94221a]">
        ...
        <motion.div
          ...
          animate={{x: 0, opacity: 1}}
          transition={{type: 'spring', duration: 0.7, delay: 1.2}}
          className="flex p-8 flex-col max-2xl:p-2 text-white/50 w-full max-w-[750px] border-l-[3px] border-black">
